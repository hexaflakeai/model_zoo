...
if [ -v PUB_MODELS_HOME ]; then
    ...
    preprocess_path="../../../../../paddlepaddle/validation/python"
fi
...
# model inference
python3 inference.py -tar aigpu -path-iroot ./${dataset_name} -path-ilab ${preprocess_path}/hx_inet1k_label.txt -nv $1
